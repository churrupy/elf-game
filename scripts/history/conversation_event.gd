...
func is_equal(other_event:EVENT) -> bool:
	...
	return PARTICIPANT_GROUP.is_equal(other_event.PARTICIPANT_GROUP)
...
func _to_string() -> String:
	return str(PARTICIPANT_GROUP)

func process_involvement(npc:NPC) -> void:
	if npc in PARTICIPANT_GROUP.PARTICIPANTS:
...
func includes_npc(target:NPC) -> bool:
	return target in PARTICIPANT_GROUP.PARTICIPANTS

# func get_all_participants() -> Array[NPC]:
# 	return PARTICIPANTS

func get_all_participants() -> Array[NPC]:
	return PARTICIPANT_GROUP.PARTICIPANTS

func to_wiki() -> Wiki:
	return PARTICIPANT_GROUP.to_wiki()
