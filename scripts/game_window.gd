...
func update_map_center() -> void:
	...
	X_RANGE = Vector2(FOCUS_LOCATION[0]-NUM_X_TILES/2, FOCUS_LOCATION[0]+(NUM_X_TILES/2 + 1))
	Y_RANGE = Vector2(FOCUS_LOCATION[1]-NUM_Y_TILES/2, FOCUS_LOCATION[1]+(NUM_Y_TILES/2 + 1))
...
func update_window() -> void:
	...
	CENTER_PANEL_LOCATION = Vector2(LEFT_PANEL_LOCATION[0] + LEFT_PANEL_SIZE[0], SCREEN_SIZE[1])

	RIGHT_PANEL_SIZE = Vector2(SCREEN_SIZE[0]/4, SCREEN_SIZE[1]/2)
	RIGHT_PANEL_LOCATION = Vector2(CENTER_PANEL_LOCATION[0] + CENTER_PANEL_SIZE[0], SCREEN_SIZE[1])

	MAP_CENTER = Vector2(CENTER_PANEL_SIZE[0]/2 + CENTER_PANEL_LOCATION[0], CENTER_PANEL_LOCATION[1]/2)
